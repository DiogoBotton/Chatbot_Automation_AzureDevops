...
from infrastructure.prompts.chatbot_prompts import get_system_prompt
from infrastructure.tools.tool_registry import get_chatbot_tools
...
class ChatbotService:
    ...
    def _get_agent(cls):
        ...
        if cls._agent is None:
            ...
            cls._agent = create_agent(llm, tools=get_chatbot_tools())
        return cls._agent
